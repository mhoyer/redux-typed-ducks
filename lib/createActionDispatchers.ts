 ...
 */
export function createActionDispatchers<TDuckTree extends object>(ducks: TDuckTree, store: Store): TDuckTree {
 ...
 */
export function createDispatchedActions<TDuckTree extends object>(ducks: TDuckTree, store: Store): TDuckTree {
